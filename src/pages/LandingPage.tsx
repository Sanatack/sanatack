...
export default function LandingPage() {
  useEffect(() => {
    // GSAP animation on page load for the galaxy backgrounds
    gsap.fromTo(
      ".galaxy-bg",
      { opacity: 0, y: -50 },
    ...
    // GSAP animation for text and navbar
    gsap.fromTo(
      ".navbar",
      { opacity: 0, y: -30 },
  ...
  return (
    <>
      <div className="relative">
        <div className="bg-[#0C0C0C] absolute h-[30rem] w-full rounded-br-[4rem] rounded-bl-[4rem]" />
      </div>
      <div className="overflow-y-hidden flex flex-col min-h-screen relative">
        ...
        {/* Background Images with GSAP classes */}
